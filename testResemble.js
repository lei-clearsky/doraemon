...
var url1 = "https://news.ycombinator.com"
...
function start() {
  ...
  page.open(url1, function() {
    ...
    console.log("Rendered url1");
    page.open(url2, function() {
      page.render('url2.png');
      console.log("Rendered url2");

      var url1Data = fs.read('url1.png');
      var url2Data = fs.read('url2.png');


      console.log("Resemble", url1Data)



      // console.log('test');
      // console.log(fs.isFile('url1.png'));
      // phantom.exit();
      ...
      function compareUrls() {
        console.log("Comparing");
            ...
            console.log("Finsihed comparing setup");
      };
    ...
    function getCompareApi(param){
      ...
      var self = {
        ...
        onComplete: function( callback ){
          console.log("Adding callback to satack", callback)
